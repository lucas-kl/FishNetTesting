...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		[Tooltip("Time required to pass before entering the interact state.")]
		...
		[Tooltip("Range")]
		public float InteractionRange = 0.30f;
		[Tooltip("What layers the character interact with")]
        ...
        {
			if(_input.interact && _interactTimeoutDelta <= 0.0f)
			{
				RaycastHit hit;
				bool isHit = Physics.BoxCast(
					this.transform.position, 
					InteractionRange * Vector3.one, 
        ...
        {
			CinemachineCameraTarget.transform.position = transform.position + Vector3.up * EyePosition;
		}
